...
function HttpClient(operation, params)
{
	...
	self.makeRequest = function()
	{
		...
		if (typeof params.requestGenerator == 'function') {
			params.requestGenerator(params, options, lib.request, getConnect(id, requestFinished));
			return;
		}
...
var Operation = function(options, Constructor, callback)
{
	...
	function startClients() {
		...
		{
            if (typeof options.paramValues == 'object') {
                if (i == options.paramValues.length - 1) {
                    i = 0;
                } else {
                    i++;
                }
                options.url = url.replaceAll(options.indexParam, options.paramValues[i]);
            }
            else if (options.indexParam) {
